...
public class CompileError : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RenderSettings.skybox.SetColor("_Tint", _twilght);
    }
    ...
    void Update()
    {
        ...
        {
            skyTint = Color.Lerp(_twilght, Color.black, -1 * colorAngle);
        }
        else
            {
                skyTint = Color.Lerp(_twilght, new Color(.5f, .5f, .5f), colorAngle);
            }
